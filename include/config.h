...
#define SHAFT_SPD_COARSE_RESISTOR_PIN    A1
#define SHAFT_SPD_FINE_TUNE_RES_PIN      A0
#define SHAFT_START_BUTTON_PIN           13
#define SHAFT_TURBO_BUTTON_PIN           10
const uint8_t SHAFT_KOEF_FINE_TUNE = 10;

#define SLICER_SPD_COARSE_RESISTOR_PIN   A2
#define SLICER_SPD_FINE_TUNE_RES_PIN     A4
#define SLICER_START_BUTTON_PIN          12
#define SLICER_TURBO_BUTTON_PIN          8
const uint8_t SLICER_KOEF_FINE_TUNE = 10;

// конфигурация мотора вала
#define MOTOR_SHAFT_PUL_PIN              9

// конфигурация мотора резака
#define MOTOR_SLICER_PUL_PIN             11
